...
r1 = requests.get(url = "https://www.zaragoza.es/api/recurso/urbanismo-infraestructuras/tranvia/2001.json?srsname=wgs84")
data1 = r1.json()

r2 = requests.get(url = "https://www.zaragoza.es/api/recurso/urbanismo-infraestructuras/tranvia/2002.json?srsname=wgs84")
data2 = r2.json()
